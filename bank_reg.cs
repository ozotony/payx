namespace XPay
{
    ...
    public partial class bank_reg : Page
    {
        ...
        protected DropDownList selectBank;
        ...
        private XObjs.XBanker xmem = new XObjs.XBanker();
        protected TextBox xname;
        protected TextBox xpass;
        protected TextBox xposition;
        ...
        {
            if (((((this.xname.Text == "") || (this.xcity.Text == "")) || ((this.xaddress.Text == "") || (this.xtelephone.Text == ""))) || (((this.xemail.Text == "") || (this.xpass.Text == "")) || (this.xposition.Text == ""))) || (this.xcode.Text == ""))
            {
                if (this.xname.Text == "")
                {
                ...
                if (this.xposition.Text == "")
                {
                    this.xposition.BorderColor = Color.Red;
                }
                else
                {
                    this.xposition.BorderColor = Color.Green;
                }
                if (this.xcode.Text == "")
                {
            ...
            else if (((((this.xname.Text != "") && (this.xcity.Text != "")) && ((this.xaddress.Text != "") && (this.xtelephone.Text != ""))) && (((this.xemail.Text != "") && (this.xpass.Text != "")) && (this.xposition.Text != ""))) && (this.xcode.Text != ""))
            {
                int num = 0;
                    ...
                    else
                    {
                        ...
                        if (!flag && !flag2)
                        {
                            ...
                            if (num3 > 0)
                            {
                                ...
                                this.xmem.xposition = this.xposition.Text;
                                this.xmem.bankname = this.selectBank.SelectedValue;
                                ...
                                if (num2 > 0)
                                {
                                    ...
                                    string msg = str8 + "Password: " + this.xpass.Text + "<br/>System ID :CLD/RC/" + num2.ToString().PadLeft(5, '0') + ",<br/>Regards";
                                    str8 = (("Dear " + this.xname.Text.ToUpper() + ",\r\n") + "You have been registered on the CLD Platform!Please store the details below\r\n") + "Username: " + this.xemail.Text + ";\r\n";
                                    ...
                                    base.Response.Redirect("bank_reg_succ.aspx?x=" + this.xname.Text.ToUpper() + "&m=CLD/RB/" + num2.ToString().PadLeft(5, '0'));
                                }
                            }
                        }
                        else
