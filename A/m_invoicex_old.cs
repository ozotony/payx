namespace XPay.A
{
    ...
    public partial class m_invoicex_old : Page
    {
        ...
        protected void ProceedToPayment_Click(object sender, EventArgs e)
        {
            ...
            this.xispf.product_id = ConfigurationManager.AppSettings["pd_product_id"];
            this.xispf.currency = ConfigurationManager.AppSettings["pd_currency"];
            this.xispf.site_redirect_url = ConfigurationManager.AppSettings["pd_site_redirect_url"];
            ...
            this.xispf.mackey = ConfigurationManager.AppSettings["pd_mackey"];
