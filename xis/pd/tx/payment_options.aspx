<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_options.cs" Inherits="XPay.xis.pd.tx.payment_options" %>
      ...
      <tr>
        ...
        <tr>
           ...
           POWERED BY<br/><img alt="Einao Solutions" src="../../../images/einao_logo.png"   width="90px" height="39px"/>
            <img alt="interswitch"   src="../../../images/isw_logo_small.gif" />
            <br />
