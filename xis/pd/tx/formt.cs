namespace XPay.xis.pd.tx
{
    ...
    public partial class formt : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.site_redirect_url = ConfigurationManager.AppSettings["pd_site_redirect_url_test"];
            this.pay_item_id = ConfigurationManager.AppSettings["pd_pay_item_id"];
            this.pd_payment_page = ConfigurationManager.AppSettings["pd_payment_page_test"];
