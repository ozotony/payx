namespace XPay
{
    ...
    public partial class mem_reg : Page
    {
        ...
        private XObjs.XMember xmem = new XObjs.XMember();
                        ...
                        if (!flag && !flag2)
                        {
                            ...
                            if (num3 > 0)
                            {
                                ...
                                if (num2 > 0)
                                {
                                    ...
                                    base.Response.Redirect("mem_reg_succ.aspx?x=" + this.xname.Text.ToUpper() + "&m=CLD/RC/" + num2.ToString().PadLeft(5, '0'));
                                }
                            }
                        }
                        else
